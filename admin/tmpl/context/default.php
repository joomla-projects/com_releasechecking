...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'contextTab', array('active' => 'details')); ?>

	<?php echo Html::_('uitab.addTab', 'contextTab', 'details', Text::_('COM_RELEASECHECKING_CONTEXT_DETAILS', true)); ?>
		<div class="row">
			<div class="col-md-6">
				<?php echo LayoutHelper::render('context.details_left', $this); ?>
			</div>
			<div class="col-md-6">
				<?php echo LayoutHelper::render('context.details_right', $this); ?>
			</div>
		</div>
	...
	<?php echo Html::_('uitab.addTab', 'contextTab', 'publishing', Text::_('COM_RELEASECHECKING_CONTEXT_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
				<?php echo LayoutHelper::render('context.publishing', $this); ?>
			</div>
			<div class="col-md-6">
				<?php echo LayoutHelper::render('context.publlshing', $this); ?>
			</div>
		</div>
	<?php echo Html::_('uitab.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo Html::_('uitab.addTab', 'contextTab', 'permissions', Text::_('COM_RELEASECHECKING_CONTEXT_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
