...
/**
 * Release_checking Html View class for the Joomla_versions
 */
class Release_checkingViewJoomla_versions extends HtmlView
{
	/**
	...
	protected function addToolBar()
	{
		...
		$this->help_url = Release_checkingHelper::getHelpUrl('joomla_versions');
