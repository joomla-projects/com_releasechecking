...
class Release_checkingViewImport extends JViewLegacy
{
	...
	{		
		if ($this->getLayout() !== 'modal')
		{
			...
			Release_checkingHelper::addSubmenu('import');
		}
		...
		$this->canDo = Release_checkingHelper::getActions('import');
		...
		if($this->hasPackage && $this->dataType)
		{
			...
			$this->headers 		= Release_checkingHelper::getFileHeaders($this->dataType);
			// clear the data type
	...
	{
		JToolBarHelper::title(JText::_('COM_RELEASE_CHECKING_IMPORT_TITLE'), 'upload');
		JHtmlSidebar::setAction('index.php?option=com_release_checking&view=import');
