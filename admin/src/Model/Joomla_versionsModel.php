 ...
 * @since  1.6
 */
class Joomla_versionsModel extends ListModel
{
	/**
	...
	*/
	...
	protected function checkInNow(): bool
	{
		...
		if ($time)
		{
			...
			$query = $db->getQuery(true);
			$query->select('*');
			$query->from($db->quoteName('#__releasechecking_joomla_version'));
			...
			if ($db->getNumRows())
			{
				...
				// Check table.
				$query->update($db->quoteName('#__releasechecking_joomla_version'))->set($fields)->where($conditions); 
